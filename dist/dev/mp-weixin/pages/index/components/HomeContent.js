...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const tapAct = () => {
      common_vendor.index.switchTab({ url: "/pages/activity/ActivityLaunch" });
    };
    ...
    const gIsShow = common_vendor.ref(false);
    const giftShow = async () => {
      const res = await services_HomeContent.giftIsShow();
      console.log(res);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/Shared/Files From d.localized/项目储存/Academic-Evening-Tea-zhy_demo/Academic-Evening-Tea-zhy_demo/src/pages/index/components/HomeContent.vue"]]);
